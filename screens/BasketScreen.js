    ...
    <StyledSafeAreaView className='flex-1 bg-white'>
      <StyledView className='flex-1 bg-gray-100'>
        ...
        <StyledScrollView className='divide-y divide-gray-200'>
          {Object.entries(groupedItemsInBasket).map(([key, items]) => (
            <StyledView key={key}
              ...
              <StyledText className='text-[#00CCBB]'>{items.length} x</StyledText>
              <StyledImage
              ...
              <StyledTouchableOpacity >
                <StyledText className='text-[#00CCBB] text-xs'
        ...
        <StyledView className='p-5 bg-white mt-5 space-y-4'>
          ...
          <StyledTouchableOpacity onPress={()=> navigation.navigate('PreparingOrder')}
